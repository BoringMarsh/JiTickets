...
public interface ActivityPersonalService {
    List<ActivityShortInfo> getActivityPage(int page);
    ActivityDetailedInfo getActivity(int id);
    ...
    void changeIndentRating(ChangeIndentRatingRequest changeIndentRatingRequest);
}
